# Runtime Testing for Better Convex ORM

Comprehensive guide to runtime testing using convex-test library with Vitest in edge-runtime environment.
...
- [Test File Setup](#test-file-setup)
- [Basic Testing Patterns](#basic-testing-patterns)
- [Testing with Context Injection](#testing-with-context-injection)
- [Testing Mutations and Writes](#testing-mutations-and-writes)
- [Testing Edge Operations](#testing-edge-operations)
- [Testing Query Operations](#testing-query-operations)
- [Testing Default Fields](#testing-default-fields)
- [Testing Unique Constraints](#testing-unique-constraints)
- [Testing Rules](#testing-rules)
- [Testing Cascading Deletes](#testing-cascading-deletes)
- [Testing System Tables](#testing-system-tables)
- [Testing Scheduled Functions](#testing-scheduled-functions)
