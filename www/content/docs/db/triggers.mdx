...
[Convex Helpers Triggers](https://github.com/get-convex/convex-helpers) provide database-level hooks that run automatically on insert/update/delete operations:
...
Create a triggers registration file:
...
Wrap mutations to apply triggers:
...
The `change` object contains operation info:
...
Many Convex components provide trigger helpers for automatic maintenance.
...
Triggers will NOT execute when:
...
**Caught errors don't roll back the mutation:**
