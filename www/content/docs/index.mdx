...
| [Triggers](/docs/server/components/triggers) | Automatic side effects on insert/update/delete. Use `convex-helpers/server/triggers`. |
| [Aggregates](/docs/server/components/aggregates) | O(log n) counts and sums with `@convex-dev/aggregate`. Leaderboards, running totals. |
...
2. [Triggers](/docs/server/components/triggers) → automatic side effects
3. [Aggregates](/docs/server/components/aggregates) → counts and sums
