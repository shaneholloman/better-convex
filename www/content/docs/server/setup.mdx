...
Before creating procedures, you'll need a database schema. These docs assume Better-Convex ORM (see [/docs/db/orm](/docs/db/orm)):
...
You can add custom properties to the base context. The most common is attaching Better-Convex ORM as `ctx.orm`:
